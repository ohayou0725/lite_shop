package com.ohayou.liteshop.upload;
...
public class QiniuUpload {
    ...
    public String upload(String filePath, String fileKey) throws IOException {
        ...
        try {
            ...
            // 解析上传成功的结果
            DefaultPutRet defaultPutRet = objectMapper.readValue(res.bodyString(), DefaultPutRet.class);
//            DefaultPutRet putRet = new Gson().fromJson(res.bodyString(), DefaultPutRet.class);
            return fileDomain + "/" + defaultPutRet.key;
